...
const answers = ["have", "ever", "taken", "has", "ever","dreamt","have","ever","been","have","ever","sold"
  , "has" , "ever", "woken up"  ];
...
function checkAnswers() {
  ...
  const userAnswers = [
    ...
    document.getElementById("exercise12").value.toLowerCase(),
    document.getElementById("exercise13").value.toLowerCase(),
    document.getElementById("exercise14").value.toLowerCase(),
    document.getElementById("exercise15").value.toLowerCase(),
  ];
